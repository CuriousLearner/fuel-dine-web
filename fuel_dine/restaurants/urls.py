...
urlpatterns = [
    ...
    url(r'^api/restaurant/(?P<pk>\d+)/vote/(?P<action>\w+)$', views.vote_for_restaurant,
        name='comment-create'),

    url(r'^api/restaurant/(?P<pk>\d+)/thumbdown/$', views.thumbs_down_for_restaurant,
        name='comment-create'),

    url(r'^api/restaurant/(?P<pk>\d+)/visited/$', views.mark_restaurant_visited,
        name='comment-create'),
