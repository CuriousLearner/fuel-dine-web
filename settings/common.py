# -*- coding: utf-8 -*-
"""Django settings for fuel_dine project.
...
APPS_DIR = ROOT_DIR.path('fuel_dine')
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'fuel_dine.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    'EXCEPTION_HANDLER': 'fuel_dine.base.exceptions.exception_handler',
}
# DJANGO_SITES
# ------------------------------------------------------------------------------
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://localhost/fuel_dine'),
}
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'fuel_dine.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = 'fuel_dine.base.views.csrf_failure'
