...
def dev():
    ...
    env.remote = 'origin'
    env.branch = 'master'
    env.hosts = ['qa.fuel_dine.com']
    env.dotenv_path = '/home/ubuntu/dev/fuel_dine/.env'
...
def qa():
    ...
    env.branch = 'qa'
    env.hosts = ['qa.fuel_dine.com']
    env.dotenv_path = '/home/ubuntu/qa/fuel_dine/.env'
    env.config_setter = fab.run
...
def prod():
    ...
    env.remote = 'origin'
    env.branch = 'prod'
    env.hosts = ['prod.fuel_dine.com']
    env.dotenv_path = '/home/ubuntu/prod/fuel_dine/.env'
    env.config_setter = fab.run
